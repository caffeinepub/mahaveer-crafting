...
export class Backend implements backendInterface {
    ...
    async addGalleryItem(arg0: string, arg1: string, arg2: string, arg3: [string, string]): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async adminLogin(arg0: [string, string]): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async deleteGalleryItem(arg0: bigint, arg1: [string, string]): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getQuoteRequest(arg0: bigint): Promise<QuoteRequest> {
        if (this.processError) {
            try {
    ...
    async submitQuoteRequest(arg0: QuoteRequest): Promise<bigint> {
        if (this.processError) {
            try {
